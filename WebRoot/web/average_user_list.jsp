...
<body class="sarchbody">
    ...
    <div class="rightinfo">
	<div class="tools">
	<form action="User_listForAverage.action" method="post" >
    <ul class="toolbarm">
		 <li><label>年度</label>  
		    <div class="vocation">
		    <select class="select3"	name="year.yid">
			     <s:iterator value="yearList" var="year">
			     	<s:if test="#session.year.yid==#year.yid">
    ...
    <table class="tablelist">
        ...
        <tr>
	        ...
	        <td>
	        	<div class="tools">
			    	<ul class="toolbar">
			    	<li onclick="javascript:window.location.href='Average_lookAverage.action?user.uid=<s:property value="#u.uid"/>' ">
			        <span><img src="images/t04.png" /></span>查看</li>
			        <li onclick="window.location.href='Average_toAverage.action?user.uid=<s:property value="#u.uid"/>' " >
