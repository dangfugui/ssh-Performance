...
<body>
    ...
    <div id="usual1" class="usual"> 
  	...
  	<input type="hidden" name="contentKPI.state" value="kpi" />
    <ul class="forminfo">
    <li><label>指标名称<b>*</b></label><input name="contentKPI.name" type="text" class="dfinput" value="<s:property value="contentKPI.name" />"   /></li>
    <li><label>指标权重<b>%</b></label><input  onblur="num(this)"  
    	name="contentKPI.weight" type="text" class="dfinput" value="<s:property value="contentKPI.weight" />"  /></li>
    <li><label>定义、公式</label>
    <textarea style="height: 160px" name="contentKPI.definde" class="dfinput" ><s:property value="contentKPI.definde" /></textarea></li>
    <li><label>目标值</label><input name="contentKPI.aim" type="text" class="dfinput" value="<s:property value="contentKPI.aim" />"  /></li>
    <li><label>计分方法</label>
    <textarea style="height: 160px" name="contentKPI.process" class="dfinput" ><s:property value="contentKPI.process" /></textarea></li>
    <li><label>数据来源</label>  
	    <div class="vocation">
    ...
    <textarea style="height: 160px" name="contentKPI.actual"  class="dfinput" ><s:property value="contentKPI.actual" /></textarea></li>
